...
class _PropagationBase(object):
    def __init__(self, model, task):
        ...
        self.encoder, self.decorder = model
    ...
    def forward(self, image):
        ...
        # self.encoder.zero_grad()  # Sets gradients of all model parameters to zero
        # self.decorder.zero_grad()  # Sets gradients of all model parameters to zero
        features = self.encoder(self.image)
        self.preds =  self.decorder(features) # [1, 19, h, w]
